      ...
      builder: (context) => StatefulBuilder(
        builder: (context, setState) => AlertDialog(
          ...
          content: SizedBox(
            ...
            child: Column(
              ...
              children: [
                    ...
                    children: [
                      CircleAvatar(
                        ...
                        backgroundImage: teacher['photoUrl'] != null
                            ? NetworkImage('http://192.168.18.15:3000${teacher['photoUrl']}')
                            : null,
                ...
                Expanded(
                  child: ListView(
                    children: subjectTypes.map((type) {
                      final isCurrentlyAssigned = currentSubjectsMap.containsKey(type);
                      final subjectData = currentSubjectsMap[type];
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: (selectedSubjects.length == currentSubjects.length && 
                         selectedSubjects.containsAll(currentSubjects.map((s) => s['type']))) || isLoading
                  ? null
                  : () async {
                      ...
                      try {
                        ...
                        for (final subject in currentSubjects) {
                          if (!selectedSubjects.contains(subject['type'])) {
                        ...
                        for (final subjectType in selectedSubjects) {
                          if (!currentSubjectsMap.containsKey(subjectType)) {
                        ...
                        if (addedCount > 0 && removedCount > 0) {
                          message = '$addedCount matéria(s) adicionada(s) e $removedCount removida(s) com sucesso!';
                        } else if (addedCount > 0) {
                          message = '$addedCount matéria(s) adicionada(s) com sucesso!';
                        } else if (removedCount > 0) {
                          message = '$removedCount matéria(s) removida(s) com sucesso!';
                        }
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                            content: Text('Erro ao gerenciar matérias: $e'),
                                        ...
                                        Row(
                                          children: [
                                            ...
                                            IconButton(
                                              ...
                                              tooltip: 'Gerenciar matérias do professor',
                                              onPressed: () => _showManageTeacherSubjectsDialog(
                                                teacher: teacher,
