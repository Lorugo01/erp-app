...
class TecaAIEquipamentosScreen extends StatefulWidget {
  const TecaAIEquipamentosScreen({super.key});

  @override
  State<TecaAIEquipamentosScreen> createState() =>
      _TecaAIEquipamentosScreenState();
}

class _TecaAIEquipamentosScreenState extends State<TecaAIEquipamentosScreen> {
...
class _AddEditItemDialog extends StatefulWidget {
  ...
  final TextEditingController? itemPositionController;
